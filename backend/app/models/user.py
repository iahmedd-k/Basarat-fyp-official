...
class User(Base):
    ...
    risk_profile = relationship("RiskProfile", back_populates="user", uselist=False, lazy="selectin")
    notification_prefs = relationship("NotificationPreference", back_populates="user", uselist=False, lazy="selectin")
